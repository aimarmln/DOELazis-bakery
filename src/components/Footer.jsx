...
const Footer = () => {
  ...
  return (
    <footer className="relative py-9 px-52 text-white flex justify-around flex-wrap bg-darkBrown">
      <div className="mb-4">
        <p className="font-medium text-center">DELIVERY SERVICE</p>
      ...
      <div className="sm:mb-4">
        <p className="font-medium text-center">STAY IN TOUCH</p>
      ...
      <p className="absolute bottom-5 text-xs">&copy; 2023 Athiya & Aimar. All rights reserved.</p>
    </footer>
  );
}
